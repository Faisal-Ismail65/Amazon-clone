    ...
    try {
      ...
      httpErrorHandle(
        ...
        onSuccess: () {
          ...
          sales = [
            Sales('Mobiles', res['mobilesEarning']),
            Sales('Essentials', res['essentialsEarning']),
            Sales('Books', res['booksEarning']),
            Sales('Appliances', res['applancesEarning']),
            Sales('Fashion', res['fashionsEarning']),
          ];
        },
      );
    } catch (e) {
