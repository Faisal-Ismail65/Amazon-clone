...
import 'package:amazon_flutter/features/product/screens/product_details_screen.dart';
import 'package:amazon_flutter/features/search/services/search_services.dart';
import 'package:amazon_flutter/features/search/widget/searched_product.dart';
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  final SearchServies searchServies = SearchServies();
  @override
  void initState() {
  ...
  fetchSearchedProduct() async {
    products = await searchServies.fetchSearchedProduct(
      context: context,
